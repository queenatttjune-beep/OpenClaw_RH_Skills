...
| 7 | `minimax/hailuo-h3/text-to-video` |
| 8 | `bytedance/seedance-2.5-token/text-to-video` |
...
| 7 | `minimax/hailuo-h3/image-to-video` |
| 8 | `bytedance/seedance-2.5-token/image-to-video` |
...
- "效果最好的" / "创意最好的" → choice 2 (全能X) or 3 (可灵) or 8 (Seedance 2.5)
- "最长的" / "15秒" / "30秒" / "长视频" / "自动配音" / "4K" → recommend choice 8 (Seedance 2.5)
- "2K" / "海螺" / "Hailuo" / "H3" → choice 7 (MiniMax H3)
- "多模态" / "图片+视频" → use multimodal endpoint: `bytedance/seedance-2.5-token/multimodal-video`
- Real people in image → recommend choice 3 (可灵) or 8 (Seedance 2.5, also supports real people)
...
**MiniMax H3 special handling (choice 7):**
...
**Seedance 2.5 special handling (choice 8):**
- When user picks 8, warmly mention: "Seedance 2.5 效果超棒！支持最长 30 秒、自动配音、最高 4K！要多长？默认 5 秒"
...
> "哎呀，全能视频S 那边服务器忙不过来了～ 要不要我换 🚀全能视频V3.1 Fast 帮你重新生成？一般不会失败的！"
