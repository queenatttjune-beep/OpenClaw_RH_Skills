...
**356 个标准 API 端点 + 无限 AI 应用**，覆盖图片、视频、音频、3D 模型生成、多模态文本理解，以及任意用户创建的 AI 应用（ComfyUI 工作流）。

## 能力一览

| 类别 | 端点数 | 支持任务 |
|------|--------|----------|
| **图片** | 78 | 文生图、图生图、图片放大、Midjourney 风格 |
| **视频** | 198 | 文生视频、图生视频、首尾帧生成、视频续写/编辑、运动控制、多模态视频 |
| **音频** | 18 | 文字转语音、音乐生成、声音克隆 |
| **3D** | 16 | 文字转 3D、图片转 3D、多图转 3D |
| **文本** | 46 | 图片理解、视频理解、文本处理 |
...
├── scripts/
│   ├── runninghub.py               # 标准模型 API 客户端（356 端点）
